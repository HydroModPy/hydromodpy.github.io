...
Flat index of all 88 curated gallery cases. Cases are sorted alphabetically by title. Use the in-page browser search to filter by category or solver name.
...
.. list-table::
   ...
   * - :doc:`Dupuit Seepage Limit 1D <cases/dupuit_seepage_limit_1d>`
     - Validation Benchmarks
